---
type: manifest
title: "ue-wiki-llm raw content manifest"
imported: 2026-05-09
...
> 본 폴더는 사용자의 기존 UE 5.7.4 LLM Wiki (`C:\Unreal\UnrealEngine\LLM_Wiki`) 의 *content* 를 그대로 복사한 것. **불변** (Karpathy LLM Wiki 패턴의 raw layer).
>
