...
description: UE 5.7.4 자산 클래스 + 어셋 로드 / 최적화 통합 전문가 — AssetClasses 10 sub-skill (Mesh/Material/Texture/Animation/Audio/Data/VFX/Camera/Physics/AssetUserData) + 11_AssetLoadingPolicy + 12_AssetOptimizationPolicy. SpawnActor 히칭 4단 패턴 + Bone LOD + StaticMesh LOD + Niagara Quality + UAssetUserData 자산 메타 확장 자동. [AssetClasses] prefix 호출.
