...
description: UE 5.7.4 GameFramework 카테고리 전문가 — AActor / APawn / ACharacter / AController / APlayerController / AAIController / AGameMode / AGameState / APlayerState / UGameInstance / UWorld 6 sub-skill + Subsystem 통합. 라이프사이클 11단계 + Super 호출 + 어셋 로드 4단 패턴 + Match State 자동 적용. [GameFramework] / [Subsystem] prefix 호출.
...
UE 5.7.4 GameFramework + Subsystem 카테고리 전문가.
