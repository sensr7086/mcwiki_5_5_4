...
description: UE 5.7.4 Input 카테고리 전문가 — Enhanced Input (5.x Plugin 표준) 5 sub-skill (EnhancedInput / Action / Subsystem / InputCore / Legacy). UInputAction + UInputMappingContext + ETriggerEvent + DeadZone + IMC Priority 7단계 + Couch Co-op LocalPlayer Subsystem 자동 적용. [Input] prefix 호출.
...
UE 5.7.4 Enhanced Input 표준 전문가.
