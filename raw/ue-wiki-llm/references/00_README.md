...
언리얼 엔진 5.7.4 (`C:\Unreal\UnrealEngine`) 의 **Engine/Source/Runtime** 트리(189개 모듈)를
...
1. **사실에 기반한다.** 추측은 명시("추정") 또는 생략. UE 5.7.4 트리에 실제로 존재하는 심볼만 인용.
...
- 버전: `5.7.4` (`Engine/Build/Build.version` 기준, BranchName=UE5)
