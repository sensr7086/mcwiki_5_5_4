...
> **소스 검증**: 본 규약의 매크로 사용 패턴은 모두 UE 5.7.4 트리(SlateCore·UMG)에서 grep으로 확인된 실제 사용례 기반.
...
| 날짜 | 변경 |
|------|------|
| 2026-05-04 | 최초 작성. UE 5.7.4 SlateCore/UMG 본체 grep 검증 (SObjectWidget.cpp L118 / SlateApplicationBase.cpp L227 / SlateInvalidationRoot.cpp L379+ / CurveSequence.cpp L282 / ScrollBox.cpp L690 / WidgetComponent.cpp L860 / SWorldWidgetScreenLayer.cpp L102 / UserWidget.cpp L844). 8섹션 + 작업 체크리스트 + cross-reference 9종. |
