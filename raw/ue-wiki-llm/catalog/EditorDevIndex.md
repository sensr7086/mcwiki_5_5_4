...
> 5.7.4 트리 기준 (`C:\Unreal\UnrealEngine\Engine\Source\<Editor|Developer>\<Module>`).
...
> **ToolMenus 위치 주의**: UE 5.7에서 `Engine/Source/Developer/ToolMenus/` (Editor가 아님). FMenuBuilder의 모던 대체.
