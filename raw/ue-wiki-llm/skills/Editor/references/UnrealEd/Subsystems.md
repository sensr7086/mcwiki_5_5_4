...
| 6 | `UPropertyVisibilityOverrideSubsystem` | `PropertyVisibilityOverrideSubsystem.h` | UPROPERTY 가시성 동적 오버라이드 (디테일 패널) |
...
| 9 | `UCollectionManagerScriptingSubsystem` | `CollectionManagerScriptingSubsystem.h` | 컨텐츠 브라우저 컬렉션 (Editor Scripting) |
