...
> **위치**: `Engine/Source/Runtime/Engine/Classes/Camera/CameraShakeBase.h` (439+) + `CameraModifier.h` + `CameraAnimationHelper.h`
...
```cpp
// CameraShakeBase.h:439
class UCameraShakeBase : public UObject
{
    // CameraShakeBase.h:613 — 핵심 Pattern 위임
    UPROPERTY(EditAnywhere, Instanced)
    TObjectPtr<UCameraShakePattern> RootShakePattern;

    // CameraShakeBase.h:568 — 시작
