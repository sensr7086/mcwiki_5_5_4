...
| 날짜 | 변경 |
|------|------|
| 2026-05-06 | 최초 작성. UE 5.7.4 5종 Subsystem (UEngine / UEditor / UGameInstance / UWorld / ULocalPlayer) + UDynamicSubsystem + UTickableWorldSubsystem 통합 매트릭스 + 작성 표준 패턴 + 결정 트리 (9개 시나리오 매핑) + 함정 10종 + 09_GlobalIt