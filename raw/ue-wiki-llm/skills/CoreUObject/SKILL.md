...
> Tier 1 · L2 (UObject·직렬화·리플렉션) · UE 5.7.4 기준
...
1. 사실 인용은 5.7.4 트리(`C:\Unreal\UnrealEngine\Engine\Source\Runtime\CoreUObject`)의 실제 헤더에서 grep으로 검증한 라인 번호를 (`헤더:라인`) 형식으로 표기.
