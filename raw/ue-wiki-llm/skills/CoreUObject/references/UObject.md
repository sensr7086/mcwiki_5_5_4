...
```
UObjectBase           (Public/UObject/UObjectBase.h:58)         ← UCLASS 아님, 순수 C++
  └─ UObjectBaseUtility (Public/UObject/UObjectBaseUtility.h:44) ← UCLASS 아님, 헬퍼 묶음
       └─ UObject       (Public/UObject/Object.h:94)             ← 모든 UCLASS의 루트
```
...
void UMyDataAsset::PostLoad()
{
    ...
    if (Version < 2) { /* 5.7.4 호환 변환 */ Version = 2; }
}
