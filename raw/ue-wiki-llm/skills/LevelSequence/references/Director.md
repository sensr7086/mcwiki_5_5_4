...
> **위치 (verified)**:
> - **ULevelSequenceDirector** — `Engine/Source/Runtime/LevelSequence/Public/LevelSequenceDirector.h:23`
...
| 날짜 | 변경 |
|------|------|
| 2026-05-13 | 최초 작성. **ULevelSequenceDirector 4 UFUNCTION [verified]** + **Event Track 사용 흐름** + **BP-only / C++ 자손 작성** + **CreateDirectorInstance virtual** + Binding 참조 + Multiplayer + 시나리오 5종 + 함정 10. Engine 5.7.4 검증 — LevelSequenceDirector.h:23-67. |
