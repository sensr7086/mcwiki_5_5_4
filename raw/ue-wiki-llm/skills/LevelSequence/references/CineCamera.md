...
> **위치 (verified)**:
> - **UCineCameraComponent** — `Engine/Source/Runtime/CinematicCamera/Public/CineCameraComponent.h:33-92+`
...
| 날짜 | 변경 |
|------|------|
| 2026-05-13 | 최초 작성. **UCineCameraComponent 9 핵심 필드 [verified]** + **Filmback / LensSettings / FocusSettings / CropSettings BlueprintSetter** + ECameraFocusMethod 4종 + Filmback 프리셋 6 + Focal Length 효과 4단 + Aperture DoF 효과 + Tracking Focus + ACameraRig_Crane / Rail + 시나리오 5종 + 함정 10. Engine 5.7.4 검증 — CineCameraComponent.h:33-92. |
