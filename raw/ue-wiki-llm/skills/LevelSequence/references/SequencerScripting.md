...
| 날짜 | 변경 |
|------|------|
| 2026-05-13 | 최초 작성. **UMovieSceneSequenceExtensions BP/Python API** + **ULevelSequenceEditorSubsystem** + Python 5 예제 (Sequence 생성 / Possessable / Camera 자동 / Render Queue 자동 / 일괄 처리) + 시나리오 5 + 함정 10 + Python 환경 설정. Engine 5.7.4 검증 — SequencerScripting + LevelSequenceEditor Plugin. |
