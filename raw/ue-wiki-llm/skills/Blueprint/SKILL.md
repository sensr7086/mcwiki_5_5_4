---
name: ue-blueprint
description: UE 5.7.4 Blueprint 시스템(노드 그래프 + UFUNCTION/UPROPERTY 노출 + BlueprintFunctionLibrary + Blueprint Native/Implementable Event + Macro/Interface) 위키. C++↔BP 경계 + 성능 함정(VM Thunk, Tick BP 함정) + Cooked Build 동작.
---

# Blueprint — UE 5.7.4 노드 그래프 / C++ ↔ BP 경계
