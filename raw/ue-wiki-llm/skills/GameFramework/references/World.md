...
description: UWorld (4,667 lines) + ULevel - Tick Group 8종 (PrePhysics/DuringPhysics/PostPhysics/PostUpdateWork) + Streaming 3종 + WorldSubsystem 등록.
---

# GameFramework/World — UWorld + ULevel + Streaming + WorldSubsystem

> **위치**: `Engine/Source/Runtime/Engine/Classes/Engine/World.h` (4,667 lines) + `Level.h` (66KB)
