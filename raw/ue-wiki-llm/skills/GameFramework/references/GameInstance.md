...
description: UGameInstance (664 lines) - 영속 세션 + Subsystem 4종 (Engine/GameInstance/World/LocalPlayer) + Init/Shutdown + LoadingScreen.
---

# GameFramework/GameInstance — UGameInstance + GameInstanceSubsystem

> **위치**: `Engine/Source/Runtime/Engine/Classes/Engine/GameInstance.h` (664 lines)
