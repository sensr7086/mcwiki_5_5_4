...
> **위치**: `Engine/Source/Runtime/InputCore/Classes/InputCoreTypes.h` (817 lines) + `Public/GenericPlatform/GenericPlatformInput.h` + 플랫폼별 (`Windows/Mac/Linux/Android/iOS`)
