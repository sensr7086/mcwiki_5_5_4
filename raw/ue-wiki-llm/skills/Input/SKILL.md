...
| 2 | [`Action`](./Action/SKILL.md) | `skills/Input/references/Action.md` | **UInputAction 자산** + ValueType 4종 (Bool/Axis1D/Axis2D/Axis3D) + **ETriggerEvent 7종** (Triggered/Started/Ongoing/Canceled/Completed/None) + **UInputTrigger 8종** (Pressed/Released/Hold/Tap/Pulse/Chord/Down/Combo) + **UInputModifier 9종** (DeadZone/Scale/Negate/Swizzle/Smooth/ResponseCurve/FOVScaling) |
