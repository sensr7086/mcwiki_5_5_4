...
**MovementComponent.h L60-67** ([`MovementComponent.h:60-67`](../../../../../UnrealEngine/Engine/Source/Runtime/Engine/Classes/GameFramework/MovementComponent.h)) — 베이스 책임 4가지:
...
### 2.1 핵심 필드 (`MovementComponent.h:80-148`)
