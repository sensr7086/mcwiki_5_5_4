...
description: UDataAsset + UPrimaryDataAsset (Bundle 표준) + UDataTable (595) + UCurveTable (339) + UCurveFloat - 데이터 기반 디자인.
---

# AssetClasses/Data — UDataAsset + UPrimaryDataAsset + UDataTable + UCurveTable + UCurveFloat

> **위치**: `Engine/Source/Runtime/Engine/Classes/Engine/DataAsset.h` (71) + `DataTable.h` (595) + `CurveTable.h` (339) + `Curves/CurveBase.h` + `CurveFloat.h`
...
## 3. UDataTable (행 기반 데이터 — 595 lines)
