...
> **위치**: Plugin (Niagara) `Engine/Plugins/FX/Niagara/Source/Niagara/Classes/NiagaraSystem.h` + Engine `Engine/Classes/Particles/ParticleSystem.h` + `VectorField/VectorField.h`
