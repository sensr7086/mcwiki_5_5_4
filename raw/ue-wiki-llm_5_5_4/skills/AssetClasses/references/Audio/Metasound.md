---
name: ue-metasound
description: UE 5.5.4 MetaSound 위키. UMetaSoundSource + UMetaSoundPatch + Graph 노드 + Trigger/Audio/Wave 데이터 타입 + Parameter Pack 런타임 제어 + AudioComponent 페어. Cascade-style USoundCue 대비 5.x DSP 그래프 표준. AssetClasses/Audio sub-skill의 5.x 페어.
---

# MetaSound — UE 5.5.4 5.x DSP 그래프 사운드 시스템
