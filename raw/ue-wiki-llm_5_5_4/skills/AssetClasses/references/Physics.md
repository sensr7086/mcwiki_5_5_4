...
> **위치**: `Engine/Source/Runtime/PhysicsCore/Public/PhysicalMaterials/PhysicalMaterial.h` + `Engine/Source/Runtime/Engine/Classes/PhysicalMaterials/PhysicalMaterialMask.h` + `Engine/Source/Runtime/Engine/Classes/PhysicsEngine/PhysicsConstraintTemplate.h` + `PhysicsAsset.h` (이미 [`AssetClasses/Mesh §4`](../Mesh/SKILL.md))
