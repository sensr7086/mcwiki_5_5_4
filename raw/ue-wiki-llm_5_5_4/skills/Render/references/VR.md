...
> **위치**: `Engine/Plugins/Runtime/OpenXR/` + `Engine/Source/Runtime/Renderer/`  
> **5.5.4 주의**: `OculusVR` 엔진 플러그인은 5.5 빌트인에서 제거됨 — Meta XR (Oculus) 통합은 `Engine/Plugins/Runtime/OpenXR/` 위에 Meta 측 외부 플러그인 (`MetaXR`) 사용. Vive/Index/PSVR2 모두 OpenXR 표준.
