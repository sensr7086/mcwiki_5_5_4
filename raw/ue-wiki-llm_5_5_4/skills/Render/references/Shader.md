...
> **위치**: `Engine/Source/Runtime/RenderCore/Public/` 안 `Shader.h` + `GlobalShader.h` + `ShaderParameterStruct.h` + `ShaderPermutation.h` + `Engine/Source/Runtime/Renderer/Public/MaterialShader.h` (5.5.4 — MaterialShader.h 는 Renderer 모듈)
