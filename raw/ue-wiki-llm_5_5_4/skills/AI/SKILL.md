---
name: ue-ai
description: UE 5.5.4 AI 시스템 위키. AAIController + Behavior Tree(Task/Service/Decorator) + Blackboard + EQS(EnvironmentQuery) + Navigation(UNavigationSystemV1, RecastNavMesh, Crowd) + Perception(Sight/Hearing/Damage). 다수 NPC 5중 최적화 + Significance 통합.
---
