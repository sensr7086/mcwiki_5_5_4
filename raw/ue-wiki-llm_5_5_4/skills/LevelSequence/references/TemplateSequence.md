...
| 날짜 | 변경 |
|------|------|
| 2026-05-13 | 최초 작성. **TemplateSequence vs LevelSequence 차이** + **Binding Type UClass 추상화** + **표준 사용 흐름 (Editor 작성 + 런타임 적용)** + 시나리오 5 (피격/사망/픽업/등장/도어) + 함정 6. Engine 5.5.4 검증 — TemplateSequence Plugin 존재. |
