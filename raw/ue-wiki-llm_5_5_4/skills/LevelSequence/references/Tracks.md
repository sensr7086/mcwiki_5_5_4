...
> **위치 (verified)**: `Engine/Source/Runtime/MovieSceneTracks/Public/Tracks/` (UE 5.5 — 41 헤더)
...
| 항목 | 신뢰도 | 검증 출처 |
|------|--------|----------|
| 43종 Track 헤더 목록 | **[verified]** ✅ | `Engine/Source/Runtime/MovieSceneTracks/Public/Tracks/` 안 ls (UE 5.5 41개 확인) |
...
| 날짜 | 변경 |
|------|------|
| 2026-05-13 | 최초 작성. **43종 빌트인 트랙 분류** (Property 16 / Cinematic 8 / Audio-VFX 5 / Animation 3 / World 4 / Sub 1 / Constraint 3 / Event 1 / CVar 1 / Text 1) + 사용 빈도 매트릭스 + 트랙 추가 표준 코드 + 함정 8 + 체크리스트 10 + 신뢰도 태그 6. Engine 5.5.4 검증 — MovieSceneTracks/Public/Tracks/ 41 헤더 ls (UE 5.5). |
