...
> - **ULevelSequencePlayer** — `Engine/Source/Runtime/LevelSequence/Public/LevelSequencePlayer.h:75, 105, 113` (UE 5.5 — 187 lines)
> - **UMovieSceneSequencePlayer** (베이스) — `Engine/Source/Runtime/MovieScene/Public/MovieSceneSequencePlayer.h` (UE 5.5 — 806 lines, 30+ UFUNCTION)
>
