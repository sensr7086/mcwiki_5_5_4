...
> **위치 (verified)**:
> - **Sequencer Editor** — `Engine/Source/Editor/Sequencer/Public/` (UE 5.5 — 35 헤더 — ISequencer / ISequencerTrackEditor / ISequencerSection 등)
