...
description: AController + APlayerController (2,477 lines) + AAIController - Possess/UnPossess + Camera + InputMode + SeamlessTravel + Voice/Audio.
---

# GameFramework/Controller — AController + APlayerController + AIController (cross-link)

> **위치**: `Engine/Source/Runtime/Engine/Classes/GameFramework/Controller.h` (420 lines) + `PlayerController.h` (2,477 lines)
...
## 3. APlayerController 깊이 (2,477 lines)
