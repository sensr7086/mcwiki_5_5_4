...
>
> **요지**: UE 5.5.4 IK 시스템은 **3축 + 1보조** — Legacy (AnimNode 8종, 단순) / **5.x IKRig** (선언적 Asset 기반, ⭐ 표준) / **5.x IKRetargeter** (Skeleton 간 모션 리타깃) / Control Rig (런타임 리깅 — 별도). 5.x 신규 게임은 **IK Rig 우선**.
