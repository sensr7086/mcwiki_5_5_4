...
> **위치**: `Engine/Source/Runtime/Engine/Classes/Components/SkeletalMeshComponent.h` (`SetSimulatePhysics:1897` / `SetAllBodiesBelowSimulatePhysics:2156` / `SetPhysicsBlendWeight:2133` / `BreakConstraint:2279`) + `Engine/Source/Runtime/Engine/Classes/PhysicsEngine/PhysicsAsset.h` (UPhysicsAsset)
