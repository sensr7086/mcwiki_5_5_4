...
2순위 — UE 5.5.4 트리 grep (`Engine/Source/...`)          [verified]
...
```
- 🔍 GitHub UE 5.5 — `Engine/Source/Runtime/Engine/Public/Animation/AnimInstance.h:NNN` [external-verified]
  https://github.com/EpicGames/UnrealEngine/blob/release/Engine/Source/Runtime/Engine/Public/Animation/AnimInstance.h#LNNN
```

---

## 3. 로컬 UE 5.5.4 트리 grep (1순위 백업 / 2순위)
...
```
- 🔍 Local UE 5.5.4 — `Engine/Source/Runtime/Engine/Public/Animation/AnimInstance.h:NNN` [verified]
```
...
| 태그 | 출처 |
|------|------|
| `[verified]` | UE 5.5.4 트리 grep + 라인 번호 |
...
- 🔍 GitHub UE 5.5 — `Engine/Plugins/Runtime/StateTree/` [external-verified]
