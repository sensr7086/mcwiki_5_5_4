...
UE 5.5.4 LevelSequence 카테고리 전문가 — 시네마틱 / 컷씬 / 영상 시스템 통합.
...
- **[verified]** — Engine 5.5.4 소스 라인번호 인용 (LevelSequenceActor.h / LevelSequencePlayer.h / MovieSceneSequencePlayer.h / CineCameraComponent.h 등)
- **[grep-listed]** — Plugin/Module 헤더 존재 확인 / 본문 미상세
- **[inferred]** — UE 일반 패턴 / 5.5.4 분기별 검증 필요
