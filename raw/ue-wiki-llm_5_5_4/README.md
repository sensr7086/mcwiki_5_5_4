# UE 5.5.4 LLM Wiki — Claude Code Plugin

> Unreal Engine 5.5.4 — 19 카테고리 + 116+ sub-skill + 15 횡단 인덱스 + Evaluator Workflow + **6개 위키 액션 커맨드**.
> Anthropic Skills Plugin 표준 준수.

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![UE 5.5.4](https://img.shields.io/badge/Unreal_Engine-5.5.4-blue)](https://www.unrealengine.com/)
...
**한 줄 요약**: 위키는 "비숙련 + 게임 로직 + UE 5.5.x + Cooked Build 검증 같이" 일 때만 +15~25%p. 그 외엔 토큰/속도/staleness 비용 ↑.
...
**전제**: 컴파일 + Cooked Build 검증 + UE 5.5.x ± 1 분기 안 + 비숙련 사용자.
