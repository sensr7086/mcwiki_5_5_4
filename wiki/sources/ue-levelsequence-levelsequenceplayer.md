...
**주요 시그니처**:
- `> - **UMovieSceneSequencePlayer** (베이스) — `Engine/Source/Runtime/MovieScene/Publ → > - **ULevelSequencePlayer** — `Engine/Source/Runtime/LevelSequence/Public/Level`

**5.5.4 에만 (5.7.4 에 없음)**:
- `> - **UMovieSceneSequencePlayer** (베이스) — `Engine/Source/Runtime/MovieScene/Public/MovieSceneSequencePlayer.h` (UE 5.5 —`
...
raw 5.5.4 본문 직접 참조: `raw/ue-wiki-llm_5_5_4/skills/LevelSequence/references/LevelSequencePlayer.md` · 5.7.4 vintage 비교: `raw/ue-wiki-llm/skills/LevelSequence/references/LevelSequencePlayer.md`
