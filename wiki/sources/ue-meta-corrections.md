...
**주요 시그니처**:
- `UE 5.7 minor 패치 (5.7.1 → 5.7.4) 만으로도 라인 번호 변경 가능. → UE 5.5 minor 패치 (5.7.1 → 5.5.4) 만으로도 라인 번호 변경 가능.`
...
raw 5.5.4 본문 직접 참조: `raw/ue-wiki-llm_5_5_4/meta/corrections.md` · 5.7.4 vintage 비교: `raw/ue-wiki-llm/meta/corrections.md`
